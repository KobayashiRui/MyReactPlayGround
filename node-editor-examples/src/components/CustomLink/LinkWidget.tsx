...
import { DefaultLinkModel, DefaultLinkPointWidget, DefaultLinkSegmentWidget} from "@projectstorm/react-diagrams";
...
export class MyLinkWidget extends React.Component<MyLinkProps, MyLinkState> {
