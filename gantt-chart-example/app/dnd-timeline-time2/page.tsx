...
const TimelineChart = dynamic(() => import('@/components/timeline_chart2/timeline'), { ssr: false })
    ...
    row_list: [
      {
        ...
        name: "group-0", 
        row_list:[
          {id: "row-0", name:"row-0", disabled: false},
          {id: "row-1", name:"row-1", disabled: false},
        ]
      },
      {
        id: "group-1", 
        name: "group-1", 
        row_list:[
          {id: "row-2", name:"row-2", disabled: false},
          {id: "row-3", name:"row-3", disabled: false},
        ]
      },
    ]
  },
  {
    ...
    row_list: [
      { 
        ...
        name: "group-3", 
        row_list:[
          {id: "row-4", name: "row-4", disabled: false},
        ]
      },
    ]
  }
